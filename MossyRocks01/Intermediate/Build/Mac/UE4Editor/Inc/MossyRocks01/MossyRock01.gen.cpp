...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AMossyRock01()
	{
		...
		if (!OuterClass)
		{
...
#endif
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bMossyStaticMesh_MetaData[] = {
				{ "Category", "MyBPForCPP" },
				{ "ModuleRelativePath", "Public/MossyRock01.h" },
			};
#endif
			static const UE4CodeGen_Private::FClassPropertyParams NewProp_bMossyStaticMesh = { UE4CodeGen_Private::EPropertyClass::Class, "bMossyStaticMesh", RF_Public|RF_Transient|RF_MarkAsNative, 0x0014000000010015, 1, nullptr, STRUCT_OFFSET(AMossyRock01, bMossyStaticMesh), Z_Construct_UClass_UMossyStaticMesh01_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(NewProp_bMossyStaticMesh_MetaData, ARRAY_COUNT(NewProp_bMossyStaticMesh_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bMossyStaticMesh,
	...
	IMPLEMENT_CLASS(AMossyRock01, 1609654390);
